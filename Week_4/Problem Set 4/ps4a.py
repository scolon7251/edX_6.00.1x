...
WORDLIST_FILENAME = "/Users/samuelcolon/Documents/MIT Course/Problem Set 4/words.txt"
...
def getWordScore(word, n):
    ...
    start = 0
    for i in word:
        point = SCRABBLE_LETTER_VALUES[i]
        start += point
    score = start * len(word)
...
def playHand(hand, wordList, n):
    ...
    * After every valid word: the score for that word is displayed,
      ...
      is asked to input another word.j
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    # Reject invalid word (print a message followed by a blank line)
        ...
        # Tell the user how many points the word earned, and the updated total score, in one line followed by a blank line
                ...
                print word + ' ' + 'earned ' + str(WordScore) + ' points.  Total Score:', TotalScore 
                WordScore = 0
